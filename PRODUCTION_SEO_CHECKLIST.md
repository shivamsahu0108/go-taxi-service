# Go Taxi Jabalpur — Production SEO Checklist

## Current production URL
https://gotaxiservice.onrender.com/

## Website completed
- Canonical, Open Graph, Twitter and schema URLs use the current Render domain.
...
- Vite preview allows the current Render hostname.
...
4. Set the website URL to https://gotaxiservice.onrender.com/ until a custom domain is connected.
5. Add genuine vehicle, office/location and service photos.
6. Collect genuine customer reviews and reply to them.

## Google Search Console
1. Verify `gotaxiservice.onrender.com` or the final custom domain.
